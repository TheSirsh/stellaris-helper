...
function selectSpecies(i: number): void {
  ...
  const speciesActive: HTMLElement | null = document.querySelector(".leader__trait-container_active");
  if (speciesActive) { speciesActive.classList.toggle("leader__trait-container_active"); }
  ...
  speciesLeaderArray.forEach(function(elem: Element, i: number) {
