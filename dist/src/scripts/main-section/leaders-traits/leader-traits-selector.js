...
function selectLeaderTrait(i, traitArray, active) {
    if (traitArray[i].exclude !== undefined) {
        const traitActive = document.querySelectorAll(".leader-traits__trait-container_active");
    ...
    const notActiveArr = document.querySelectorAll(".leader-traits__trait-container");
    ...
    activateTrait(document.querySelector(".leader-traits__descr-title"), document.querySelector(".leader-traits__descr-text"), traitArray, i);
}
