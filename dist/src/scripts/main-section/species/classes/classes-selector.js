...
function selectClasses(i) {
    const classesActive = document.querySelector(".classes__trait-container_active");
    if (classesActive) {
        classesActive.classList.toggle("classes__trait-container_active");
    }
    const classesHM = document.querySelector(".classes-hm__traitlist");
    if (classesHM) {
        classesHM.remove();
    }
    const classesBio = document.querySelector(".classes-bio__traitlist");
    if (classesBio) {
        classesBio.remove();
    }
    if (i !== 0) {
        const classesTraitBlock = document.querySelector(".classes__traitlist-block");
        if (i !== 1) {
            createTraitList(classesTraitBlock, classesTraitsBiological, "classes-bio");
            const classesTraitNotHM = document.querySelectorAll(".classes-bio__trait-container");
        ...
        const classesTraitBio = document.querySelectorAll(".classes-hm__trait-container");
