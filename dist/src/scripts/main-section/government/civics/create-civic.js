...
import { civicsStandart } from "./civics-standart.js";
import { civicsCorporate } from "./civics-corporate.js";
import { civicsHiveMind } from "./civics-hive-mind.js";
import { civicsMachine } from "./civics-machine.js";
import { mutuallyChecking } from "../../../mutually-checking.js";
function createCivics() {
    const authority = localStorage.getItem("authority");
    let validArray;
    if (authority === "auth_hive_mind") {
        validArray = civicsHiveMind;
    }
    else if (authority === "auth_machine_intelligence") {
        validArray = civicsMachine;
    }
    else if (authority === "auth_corporate") {
        validArray = civicsCorporate;
    }
    else
        (validArray = civicsStandart);
